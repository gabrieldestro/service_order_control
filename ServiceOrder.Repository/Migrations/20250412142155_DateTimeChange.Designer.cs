...
namespace ServiceOrder.Repository.Migrations
{
    ...
    [Migration("20250412142155_DateTimeChange")]
            ...
            modelBuilder.Entity("ServiceOrder.Domain.Entities.Client", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2025, 4, 12, 11, 21, 55, 280, DateTimeKind.Local).AddTicks(1343));
            ...
            modelBuilder.Entity("ServiceOrder.Domain.Entities.ElectricCompany", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2025, 4, 12, 11, 21, 55, 280, DateTimeKind.Local).AddTicks(1736));
            ...
            modelBuilder.Entity("ServiceOrder.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2025, 4, 12, 11, 21, 55, 280, DateTimeKind.Local).AddTicks(598));
            ...
            modelBuilder.Entity("ServiceOrder.Domain.Entities.OrderDeadline", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2025, 4, 12, 11, 21, 55, 280, DateTimeKind.Local).AddTicks(2103));
